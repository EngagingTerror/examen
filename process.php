...
if (isset($_GET['edit'])) {
    ...
    if (isset($_POST['update'])) {
        ...
        $mysqli->query("UPDATE reservering SET dag='$dag', klantnaam='$klantnaam', klantemail='$klantemail', telefoon'='$telefoon', aantal_personen='$aantal_personen', reserver_tijd='$reserver_tijd', jarige='$jarige' WHERE reserver_id=$reserver_id") or die ($mysqli->error());
